...
var doc=[];
var test=[];
 code.push(code_2017p);
 maintainability.push(maintainability_2017p);
 robost.push(robost_2017p);
 ability.push(ability_2017p);
 config.push(config_2017p);
 doc.push(doc_2017p);
  test.push(test_2017p);
  var  data_pie=[
  [code[0],maintainability[0],robost[0],ability[0],config[0],doc[0],test[0]]  
];
console.log(code[0]);
